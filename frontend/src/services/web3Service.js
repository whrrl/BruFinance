...
export const convertToSmallestMegaUnit = (amount) => {
    console.log("%c Line:11 🍻 amount", "color:#4fff4B", amount);
...
//         console.log("%c Line:137 🎂 latestBlock", "color:#e41a6a", latestBlock);
...
//             latestBlock,
//         );
//         console.log("%c Line:153 🥚 BondCreated", "color:#2eafb0", BondCreated);
//         if (BondCreated) {
...
//                         coin:
//                             environment.TokenAddress == ele.args[3]
//                                 ? "USDT"
//                                 : "USDC",
